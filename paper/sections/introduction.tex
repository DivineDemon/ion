...
\begin{itemize}
  ...
  \item We run experiments on length-generalization tasks (cumulative sum, parity, Dyck-2) and on depth stability and MNIST, with parameter-matched baselines (GRU, LSTM, MLP) and 5 seeds per condition.
