  ...
  return (
    <>
      <section className="relative mt-16 flex h-[calc(100vh-64px)] flex-col items-center justify-center">
        <BackgroundPattern className="-translate-x-1/2 absolute top-20 left-1/2 z-0 opacity-35" />
        <div className="absolute top-1/2 left-1/2 z-0 size-72 rounded-full bg-primary/50 blur-[50px]" />
        <div className="absolute top-1/3 left-1/3 z-0 size-36 rounded-full bg-green-500/50 blur-[50px]" />
        <div className="relative z-[1] flex h-full flex-col items-center justify-center gap-6 pb-16 text-center">
          ...
          <p className="max-w-prose text-base/7 text-gray-600">
            With <span className="font-bold text-primary">Ion</span>, you can achieve with your team what you couldn't
            <br />
      ...
      <section className="relative pb-4">
        <div className="absolute inset-x-0 top-24 bottom-24 bg-primary" />
        <div className="relative mx-auto">
          <MaxWidthWrapper className="relative">
            <div className="-m-2 lg:-m-4 rounded-xl bg-gray-900/5 p-2 ring-1 ring-gray-900/10 ring-inset lg:rounded-2xl lg:p-4">
              <Image src={Feature} alt="feature-project" className="rounded-lg" />
            </div>
          </MaxWidthWrapper>
        </div>
      </section>
      <section className="relative bg-gray-50 py-24 sm:py-32">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div className="">
            <h2 className="text-center font-semibold text-base/7 text-primary">Intuitive Collaboration</h2>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                  <p className="mt-2 font-medium text-lg/7 text-yellow-950 tracking-tight max-lg:text-center">
                    Meeting Management
                  </p>
                  <p className="mt-2 max-w-lg text-gray-600 text-sm/6 max-lg:text-center">
                    Harness the power of AI to summarize and track meetings, extract and list issues discussed.
                  </p>
                </div>
                <div className="relative min-h-[30rem] w-full grow p-7 [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  <div className="-bottom-16 -right-16 absolute z-0 size-72 rounded-full bg-primary/50 blur-[50px]" />
                  <div className="absolute top-10 left-0 z-0 size-36 rounded-full bg-green-500/50 blur-[50px]" />
                  <Image src={MeetingManagement} alt="meeting-management" className="size-full object-contain" />
                </div>
              </div>
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col gap-5 overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-gray-600 text-sm/6 max-lg:text-center">
                    Ask the Ion AI questions about your code and find answers to your questions.
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2">
                  <Image src={Questions} alt="questions" width={500} height={300} className="w-full max-lg:max-w-xs" />
                </div>
              </div>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col gap-5 overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-gray-600 text-sm/6 max-lg:text-center">
                    Onboard new members onto your team with ease. Employ Ion AI to introduce your team members to your
                    codebase.
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2">
                  <Image src={Invite} alt="invite" width={500} height={300} className="w-full max-lg:max-w-xs" />
                </div>
              </div>
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pt-8 pb-3 sm:px-10 sm:pt-10 sm:pb-0">
                  ...
                  <p className="mt-2 max-w-lg text-gray-600 text-sm/6 max-lg:text-center">
                    Keep track of the changes made to your codebase with ease. Get summarized, easy to read insights
                    about your codebase.
                  </p>
                </div>
                <div className="relative min-h-[30rem] w-full grow p-7 [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  <div className="-bottom-16 -left-16 absolute z-0 size-72 rounded-full bg-primary/50 blur-[50px]" />
                  <div className="absolute top-10 right-0 z-0 size-36 rounded-full bg-green-500/50 blur-[50px]" />
                  <Image src={Track} alt="track" className="size-full object-contain" />
                </div>
              </div>
      ...
      <section className="relative bg-white py-24 sm:py-32">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div className="">
            <h2 className="text-center font-semibold text-base/7 text-primary">Real-World Experiences</h2>
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 divide-y divide-gray-200 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:divide-x lg:divide-y-0">
            <div className="flex flex-auto flex-col gap-4 rounded-t-[2rem] bg-gray-50 p-6 sm:p-8 lg:rounded-l-[2rem] lg:rounded-tr-none lg:p-16">
              ...
              <p className="text-pretty text-center font-medium text-base text-yellow-950 tracking-tight sm:text-lg lg:text-left lg:text-lg/8">
                Ion has been a gamechanger for me. I&apos;ve been using it for 2 months now and seeing team performance
                increase in real-time is super satisfying.
              </p>
              <div className="mt-2 flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-start lg:justify-start">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-gray-600 text-sm">@itsfreyaa</p>
                </div>
              </div>
            </div>
            <div className="flex flex-auto flex-col gap-4 rounded-b-[2rem] bg-gray-50 p-6 sm:p-8 lg:rounded-r-[2rem] lg:rounded-bl-none lg:p-16">
              ...
              <p className="text-pretty text-center font-medium text-base text-yellow-950 tracking-tight sm:text-lg lg:text-left lg:text-lg/8">
                Ion has been paying off for our team. Nice to have a simple way of seeing how we&apos;re doing
              ...
              <div className="mt-2 flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-start lg:justify-start">
                ...
                <div className="flex flex-col items-center sm:items-start">
                  ...
                  <p className="text-gray-600 text-sm">@kaidurant_</p>
                </div>
              </div>
            </div>
          </div>
