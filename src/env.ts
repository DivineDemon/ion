...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_KINDE_EMAIL_CONNECTION_ID: process.env.NEXT_PUBLIC_KINDE_EMAIL_CONNECTION_ID,
    NEXT_PUBLIC_KINDE_GITHUB_CONNECTION_ID: process.env.NEXT_PUBLIC_KINDE_GITHUB_CONNECTION_ID,
    NEXT_PUBLIC_KINDE_GOOGLE_CONNECTION_ID: process.env.NEXT_PUBLIC_KINDE_GOOGLE_CONNECTION_ID,
